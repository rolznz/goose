...
<Tabs groupId="interface">
  <TabItem value="ui" label="Goose Desktop (Local)" default>
  ...
  <TabItem value="cli" label="Goose CLI (Local)">
  ...
  <TabItem value="ui-remote" label="Goose Desktop (Remote)" default>
  ...
  <TabItem value="cli-remote" label="Goose CLI (Remote)">
  1. Run the `configure` command:
  ```sh
  goose configure
  ```
